    ...
    <div class="super_container  mt-5 pt-5">
        ...
        <div class="container mt-5 pt-5">
            ...
            if ($miCarrito && mysqli_num_rows($miCarrito) > 0) { ?>
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-center mb-5" style="border-bottom: solid 1px #ebebeb; color: #fff;">
                            Mi lista de Deseos
                        </h3>
                                ...
                                <tbody>
                                    ...
                                    while ($dataMiProd = mysqli_fetch_array($miCarrito)) { ?>
                                        <tr id="resp<?php echo $dataMiProd['tempId']; ?>">
                                            ...
                                            <td style="color: #fff;"><?php echo $dataMiProd["nameProd"]; ?></td>
                                            <td>
                                            ...
                                            <td style="color: #fff;" class="text-right"> <strong>$</strong>
                                    ...
                                    <?php  } ?>
                                    <tr style="background-color: #800F2F !important;">
                                        <td colspan="4"></td>
