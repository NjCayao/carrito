<section class="content">
	<div class="row">
		<div class="col-md-12">
			<h2><i class="fa fa-users"></i> Directorio de Clientes</h2>
			<a href='#client_new' data-toggle='modal' class='btn btn-primary'><i class='fa fa-user'></i> Nuevo Cliente</a>
			<br><br>
							...
							<table class="table table-bordered datatable table-hover">
								...
								<tr>
									...
									<td style="text-align: center;">
										...
										<a href="index.php?action=client_del&id=<?php echo $user->id;?>" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Eliminar</a></td>
								</tr>
								<?php }?>
							</table>
						</div>
