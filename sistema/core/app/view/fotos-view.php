<section class="content">
	<div class="row">
		<div class="col-md-12">
			<h2><i class="fa fa-users"></i> Mis Fotos</h2>
			<a href='#' data-id="2" data-toggle='modal' data-target="#detail_product" class="btn btn-primary"><i class='glyphicon glyphicon-user'></i> Nueva foto</a>
			<br><br>
